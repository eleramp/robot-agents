...
def plot_curves(xy_list, xaxis, labels, title):
    """
    plot the curves
...
def plot_results(dirs, num_timesteps, xaxis, task_name):
    ...
    sub_folders = []
    for folder in dirs:
        sub_folders.append(folder.split('/')[-2])
    ...
    plot_curves(xy_list, xaxis, sub_folders, task_name)
...
def main():
    ...
    parser.add_argument('--xaxis', help='Varible on X-axis', default='episodes')
