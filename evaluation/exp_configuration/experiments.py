...
register_experiment({
    'name': 'icub_reach_deepq/stable_baselines/0',
...
register_experiment({
    'name': 'icub_reach_deepq/stable_baselines/1',
    'description': 'Reach task with iCub robot, simulated in PyBullet by using DQN algorithm',
    'tasks': [{'sub_name':'random_obj_3dim', 'env_id':_env_prefix+'iCubReach-v0', 'seed': 1,
                'env_params':{'isDiscrete':1, 'control_arm':'l','rnd_obj_pose':1, 'maxSteps':1000, 'renders':False},
                },
            ],
    'algo': {   'name' : 'deepq',
...
register_experiment({
    'name': 'icub_reach_deepq/stable_baselines/2',
    'description': 'Reach task with iCub robot, simulated in PyBullet by using DQN algorithm',
    'tasks': [ {'sub_name':'random_obj_3dim', 'env_id':_env_prefix+'iCubReach-v0', 'seed': 1,
                'env_params':{'isDiscrete':1, 'control_arm':'l','rnd_obj_pose':1, 'maxSteps':1000, 'renders':False},
                },
...
register_experiment({
    'name': 'icub_reach_deepq/stable_baselines/3',
    'description': 'Reach task with iCub robot, simulated in PyBullet by using DQN algorithm',
    'tasks': [ {'sub_name':'random_obj_3dim', 'env_id':_env_prefix+'iCubReach-v0', 'seed': 1,
                'env_params':{'isDiscrete':1, 'control_arm':'l','rnd_obj_pose':1, 'maxSteps':1000, 'renders':False},
                },
...
register_experiment({
    'name': 'icub_reach_deepq/stable_baselines/4',
    'description': 'Reach task with iCub robot, simulated in PyBullet by using DQN algorithm',
    'tasks': [{'sub_name':'random_obj_3dim', 'env_id':_env_prefix+'iCubReach-v0', 'seed': 1,
                'env_params':{'isDiscrete':1, 'control_arm':'l','rnd_obj_pose':1, 'maxSteps':1000, 'renders':False},
                },
