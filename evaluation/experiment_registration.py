...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/2_control_pts/low_penalty/obj_5',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix + 'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                   'log_file': '',
...
# 2
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/2_control_pts/medium_penalty/obj_0_new_sac',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
    ...
    'algo': {'name': 'sac_residual',
             ...
             'params': {'n_timesteps': 100000,
                        'policy': 'MlpPolicy',  # options: MlpPolicy e cnns ones
                        'gamma': 0.995,
                        'learning_rate': 0.009209225155490892,
                        'batch_size': 16,
                        'buffer_size': 100000,
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/2_control_pts/medium_penalty/obj_1_new_sac',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/4_control_pts/low_penalty/obj_5',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/4_control_pts/medium_penalty/obj_5',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/4_control_pts/high_penalty/obj_5',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/8_control_pts/low_penalty/obj_5',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_1obj/2_control_pts/low_penalty/obj_5/baseline',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix + 'iCubReachResidual-v0', 'seed': 1,
               'env_params': {
                   'log_file': '',
...
n_control_pt = 2
register_experiment({
    'name': 'icub_reach_grasp_1obj/2_control_pts/medium_penalty/obj_1_base',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachGraspResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
                            'control_arm': 'r',
                            'control_orientation': 1,
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_grasp_1obj/2_control_pts/medium_penalty/obj_1',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachGraspResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_grasp_1obj/2_control_pts/medium_penalty/obj_2',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachGraspResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_grasp_1obj/2_control_pts/medium_penalty/obj_1_baseline',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachGraspResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
...
register_experiment({
    'name': 'SQ_DRL_sisq/icub_reach_grasp_1obj/2_control_pts/medium_penalty/obj_2_baseline',
    'description': '1 obj (mustard). random position and orientation. reward is: -10 fall, -1 contact, 10*1sec+100 success, 0 otherwise.',
    'tasks': [{'sub_name': '', 'env_id': _env_prefix+'iCubReachGraspResidual-v0', 'seed': 1,
               'env_params': {
                            'log_file': '',
