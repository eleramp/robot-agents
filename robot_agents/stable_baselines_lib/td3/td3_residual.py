...
from robot_agents.stable_baselines_lib.td3.policy_residual import TD3Policy
from stable_baselines import logger


class TD3_residual(OffPolicyRLModel):
    """
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000,
        ...
        super(TD3_residual, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose,
